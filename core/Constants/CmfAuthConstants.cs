...
namespace Cmf.CLI.Core.Constants
{
    public static class CmfAuthConstants
    {
        ...
        /// <summary>
        /// Repository Type identifier for Critical Manufacturing's Customer Portal
        /// </summary>
        public const string PortalRepositoryType = "portal";

        /// <summary>
        /// Repository Type identifier for NPM Package Repositories
        /// </summary>
        public const string NPMRepositoryType = "npm";

        /// <summary>
        /// Repository Type identifier for NuGet Package Repositories
        /// </summary>
        public const string NuGetRepositoryType = "nuget";

        /// <summary>
        /// Repository Type identifier for Docker Image Repositories
        /// </summary>
        public const string DockerRepositoryType = "docker";

        /// <summary>
        /// Repository Type identifier for CIFS Package Repositories
        /// </summary>
        public const string CIFSRepositoryType = "cifs";
