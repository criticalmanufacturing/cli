...
{
    public class PortalRepositoryCredentials : IRepositoryCredentials, IRepositoryInteractiveLogin, IRepositoryDerivedCredentials
    {
        #region Constants
        ...
        public string RepositoryType => CmfAuthConstants.PortalRepositoryType;
        ...
        public async Task<ICredential> InteractiveLogin()
        {
