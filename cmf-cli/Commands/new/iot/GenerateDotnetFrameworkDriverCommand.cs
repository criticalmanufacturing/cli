...
{
    /// <summary>
    /// Generates IoT Dotnet Driver Framework structure
    /// </summary>
    [CmfCommand("driver-dotnet-framework", ParentId = "new_iot", Id = "iot_dotnet-dotnet-framework", MinimumMESVersion = "11.0.0")]
    public class GenerateDotnetFrameworkDriverCommand : TemplateCommand
    {
        /// <summary>
        /// constructor
        /// </summary>
        public GenerateDotnetFrameworkDriverCommand() : base("iot-driver-dotnet-framework")
        {
        }
        ...
        public GenerateDotnetFrameworkDriverCommand(IFileSystem fileSystem) : base("iot-driver-dotnet-framework", fileSystem)
        {
        }
