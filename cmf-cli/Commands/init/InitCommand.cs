...
namespace Cmf.CLI.Commands
{
    ...
    public class InitCommand : TemplateCommand
    {
        ...
        public override void Configure(Command cmd)
        {
            ...
            {
                CustomParser = argResult => ParseArgument<string>(argResult, "Cmf.Custom.Package"),
                DefaultValueFactory = _ => "Cmf.Custom.Package"
            };
            cmd.Add(rootPackageNameArgument);

            var workingDirArgument = new Argument<IDirectoryInfo>("workingDir")
            {
                Description = "Working Directory",
                CustomParser = argResult => ParseArgument<IDirectoryInfo>(argResult, "."),
                DefaultValueFactory = _ => ParseArgument<IDirectoryInfo>(null, ".")
            };
            ...
            cmd.Add(appLicensedApplicationOption);
