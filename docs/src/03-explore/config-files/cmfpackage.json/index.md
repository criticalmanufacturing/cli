...
Optional absolute directory where declared Grafana plugins are deployed. It defaults to
...
change the Grafana image configuration. See the [Grafana plugin reference](grafana-plugins.md)
